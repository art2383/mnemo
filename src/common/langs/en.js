const en = {
  ...
  home: {
    h1: 'Home',
    things: 'Things you can do here',
    valid: 'Create valid BIP-39 mnemonic',
    invalid: 'Create alternative (invalid) mnemonic',
    input: 'Input mnemonic and check it',
    differentChains: 'Generate addresses on different blockchains',
    word12: 'Derive 12-th word from the first 11'
  },
  seed: {
